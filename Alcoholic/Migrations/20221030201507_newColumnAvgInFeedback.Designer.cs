...
namespace Alcoholic.Migrations
{
    ...
    [Migration("20221030201507_newColumnAvgInFeedback")]
    partial class newColumnAvgInFeedback
    {
            ...
            modelBuilder.Entity("Alcoholic.Models.Entities.Employee", b =>
                {
                    ...
                    b.Property<DateTime>("Join")
                        ...
                        .HasDefaultValue(new DateTime(2022, 10, 31, 4, 15, 6, 908, DateTimeKind.Local).AddTicks(8984));
